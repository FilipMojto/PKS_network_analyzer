...
INPUT_SCHEMA_PATH = 'resources\\schema-all.yaml'
TESTED_FILE_PATH = 'resources\\output.yml'
...
args_parser.add_argument('-s', '--schema', nargs='?', default=INPUT_SCHEMA_PATH, \
help='the path to schema')
args_parser.add_argument('-d', '--data', nargs='?', default=TESTED_FILE_PATH, \
